...
class BankPlacePage extends StatefulWidget {
  final Map<String, dynamic> location;

  const BankPlacePage({Key? key, required this.location}) : super(key: key);

  @override
  _BankPlacePageState createState() => _BankPlacePageState();
}

class _BankPlacePageState extends State<BankPlacePage> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            const SizedBox(height: 20),
            Text(
              '📍 ${location['city'] ?? 'No address available'}',
